	...
	<section class="section-padding">
		<div class="container">
			<div class="row showcase-section">
				<div class="col-md-6">
					<img src="{{url('front/img/dev1.png')}}" alt="showcase image">
				</div>
				<div class="col-md-6">
							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="{{url('front/img/team1.jpg')}}" alt="">
										<!-- Name -->
										<h4>Johne Doe</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="{{url('front/img/team2.jpg')}}" alt="">
										<!-- Name -->
										<h4>Jennifer</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="{{url('front/img/team3.jpg')}}" alt="">
										<!-- Name -->
										<h4>Christean</h4>
								...
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="{{url('front/img/team4.jpg')}}" alt="">
										<!-- Name -->
										<h4>Kerinele rase</h4>
