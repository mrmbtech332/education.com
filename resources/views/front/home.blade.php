  ...
  <div class="container">
	...
	<!-- Slider -->
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              <li>
                <img src="{{url('front/img/slides/1.jpg')}}" alt="" />
              ...
              <li>
                <img src="{{('front/img/slides/2.jpg')}}" alt="" />
                <div class="flex-caption">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-10 col-sm-9">
					<h3>Welcom to Cambridge EDUCATION INSTITUTE</h3>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-6">
					<div class="about-image">
						<img src="{{('front/img/about.jpg')}}" alt="About Images">
					</div>
				</div>
			</div>
		</div>
